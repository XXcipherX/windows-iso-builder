...
3. Prepare and embed a build-specific `autounattend.xml` in every final ISO; optionally run a headless Tiny11 pass to debloat the image, apply registry tweaks, and bypass Windows setup requirements.
